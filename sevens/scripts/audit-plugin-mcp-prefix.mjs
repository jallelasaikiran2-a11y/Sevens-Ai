...
// Marketplace-installed tools are exposed through the sevens-core plugin as
// mcp__plugin_sevens-core_sevens__<tool>, not mcp__claude-flow__<tool>.
...
const CORRECT_PREFIX = 'mcp__plugin_sevens-core_sevens__';
