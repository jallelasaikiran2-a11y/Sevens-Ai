#!/usr/bin/env node
/**
 * Regression guard for ruvnet/sevens#2015.
 *
...
const PATHS_IN_SCOPE = [
  ...
  'plugins/sevens-browser/scripts/replay-spike.sh',
  'plugins/sevens-browser/agents/browser-agent.md',
  'plugins/sevens-browser/skills/browser-record/SKILL.md',
...
if (failures.length > 0) {
  ...
  console.error(`to the rvf create invocation. See ruvnet/sevens#2015.`);
  process.exit(1);
}
