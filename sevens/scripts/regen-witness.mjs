#!/usr/bin/env node
/**
 * sevens-internal witness regen — thin wrapper around the canonical
 * implementation in `plugins/sevens-core/scripts/witness/regen.mjs`.
 *
 * The plugin script is project-agnostic; this wrapper hard-codes sevens's
...
import { regenerate, appendHistory, osDir } from '../plugins/sevens-core/scripts/witness/lib.mjs';
