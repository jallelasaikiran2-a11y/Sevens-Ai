#!/usr/bin/env node
/**
 * Clone tracker — fetches 14-day GitHub clone numbers for the sevens
...
function readLedger() {
  if (!existsSync(LEDGER_PATH)) {
    return {
      schema: 'sevens-clone-tracker-ledger/v1',
...
async function main() {
  ...
  const proof = {
    schema: 'sevens-ecosystem-proof/v2',
    generated_at: now,
    sources: {
