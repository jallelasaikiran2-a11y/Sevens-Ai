...
// spawns sevens-agent:nested-coordinator at L1, and that coordinator recursively
...
//
// Required state: sevens-agent plugin cache must contain the nested-* agents
// (run `claude plugin details sevens-agent` first — expect Agents (9) listed).
