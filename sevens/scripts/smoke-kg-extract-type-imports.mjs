#!/usr/bin/env node
/**
 * Smoke test for ruvnet/sevens#2049: kg-extract must NOT conflate
...
const SKILL_DIR = join(REPO_ROOT, 'plugins', 'sevens-knowledge-graph', 'skills');
...
const fixtureDir = join(tmpdir(), 'sevens-kg-fixture-' + randomBytes(4).toString('hex'));
