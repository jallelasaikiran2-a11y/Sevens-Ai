...
- **sevens-intelligence**: Coverage-gap routing uses intelligence pipeline to prioritize test generation
- **sevens-browser**: Playwright browser testing for UI-facing test gaps
