...
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__hooks_worker-dispatch Read Grep
---
...
`mcp__plugin_sevens-core_sevens__hooks_worker-dispatch({ trigger: "testgaps" })`
