...
Surfaces the **Test-Driven Repair** loop as a sevens skill. Use when you have a failing test and want the source-under-test fixed automatically, with the test's pass/fail as the verification gate (no LLM-as-judge).
...
node plugins/sevens-testgen/scripts/tdd-repair/tdd-repair.mjs \
  --repo /path/to/myrepo \
