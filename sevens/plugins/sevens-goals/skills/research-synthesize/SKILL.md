...
allowed-tools: mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__memory_search_unified mcp__plugin_sevens-core_sevens__memory_list mcp__plugin_sevens-core_sevens__memory_retrieve mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__agentdb_context-synthesize mcp__plugin_sevens-core_sevens__agentdb_pattern-search mcp__plugin_sevens-core_sevens__neural_predict Bash Read Write
---
...
1. **Gather findings** — search across research namespaces:
   - `mcp__plugin_sevens-core_sevens__memory_search` namespace `research` for raw findings
   - `mcp__plugin_sevens-core_sevens__memory_search` namespace `research-sources` for references
   - `mcp__plugin_sevens-core_sevens__agentdb_pattern-search` for discovered patterns
   - `mcp__plugin_sevens-core_sevens__agentdb_context-synthesize` for AI-assisted context building
...
4. **Predict relevance** — call `mcp__plugin_sevens-core_sevens__neural_predict` to score which findings are most relevant to the original goal
5. **Structure report**:
...
6. **Store synthesis** — call `mcp__plugin_sevens-core_sevens__memory_store` namespace `research-synthesis` with the full report
