...
allowed-tools: mcp__plugin_sevens-core_sevens__task_create mcp__plugin_sevens-core_sevens__task_list mcp__plugin_sevens-core_sevens__task_status mcp__plugin_sevens-core_sevens__task_assign mcp__plugin_sevens-core_sevens__task_update mcp__plugin_sevens-core_sevens__task_complete mcp__plugin_sevens-core_sevens__task_summary mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__neural_predict mcp__plugin_sevens-core_sevens__workflow_create mcp__plugin_sevens-core_sevens__workflow_execute mcp__plugin_sevens-core_sevens__workflow_status mcp__plugin_sevens-core_sevens__hooks_intelligence_trajectory-start mcp__plugin_sevens-core_sevens__hooks_intelligence_trajectory-step mcp__plugin_sevens-core_sevens__hooks_intelligence_trajectory-end Bash Read Write Edit
---
...
6. **Record trajectory** — call `mcp__plugin_sevens-core_sevens__hooks_intelligence_trajectory-start` to begin tracking
7. **Create tasks** — call `mcp__plugin_sevens-core_sevens__task_create` for each action in the plan
8. **Execute** — work through tasks in dependency order:
   ...
   - Record each step via `mcp__plugin_sevens-core_sevens__hooks_intelligence_trajectory-step`
...
10. **Complete trajectory** — call `mcp__plugin_sevens-core_sevens__hooks_intelligence_trajectory-end`
11. **Store successful plan** — call `mcp__plugin_sevens-core_sevens__memory_store` with namespace `goap-plans`
