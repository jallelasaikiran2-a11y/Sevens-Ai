...
allowed-tools: mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__memory_list mcp__plugin_sevens-core_sevens__memory_retrieve mcp__plugin_sevens-core_sevens__task_list mcp__plugin_sevens-core_sevens__task_summary mcp__plugin_sevens-core_sevens__progress_check mcp__plugin_sevens-core_sevens__progress_summary mcp__plugin_sevens-core_sevens__agentdb_hierarchical-store mcp__plugin_sevens-core_sevens__agentdb_hierarchical-recall mcp__plugin_sevens-core_sevens__hooks_intelligence_pattern-store mcp__plugin_sevens-core_sevens__session_save mcp__plugin_sevens-core_sevens__session_restore Bash Read Write
---
...
2. **Store horizon** — call `mcp__plugin_sevens-core_sevens__memory_store` with namespace `horizons` and key `horizon-[name]`:
   ```json
   {
     "objective": "...",
     "created": "2026-04-28",
...
3. **Session check-in** — at the start of each session:
   - Recall horizon: `mcp__plugin_sevens-core_sevens__memory_retrieve` key `horizon-[name]` namespace `horizons`
...
6. **Milestone completion** — when a milestone is done:
   ...
   - Store learned patterns via `mcp__plugin_sevens-core_sevens__hooks_intelligence_pattern-store`
