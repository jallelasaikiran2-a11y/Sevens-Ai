...
argument-hint: "<topic>"
allowed-tools: mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__memory_search_unified mcp__plugin_sevens-core_sevens__agentdb_hierarchical-store mcp__plugin_sevens-core_sevens__agentdb_hierarchical-recall mcp__plugin_sevens-core_sevens__agentdb_pattern-search mcp__plugin_sevens-core_sevens__agentdb_pattern-store mcp__plugin_sevens-core_sevens__neural_predict mcp__plugin_sevens-core_sevens__hooks_intelligence_pattern-search mcp__plugin_sevens-core_sevens__hooks_intelligence_pattern-store mcp__plugin_sevens-core_sevens__task_create mcp__plugin_sevens-core_sevens__task_list mcp__plugin_sevens-core_sevens__task_summary Bash WebSearch WebFetch Read Write
---
...
2. **Search existing knowledge** — call `mcp__plugin_sevens-core_sevens__memory_search_unified` and `mcp__plugin_sevens-core_sevens__agentdb_pattern-search` to check what's already known
...
6. **Store findings** — call `mcp__plugin_sevens-core_sevens__memory_store` with namespace `research` for each key finding
7. **Store patterns** — call `mcp__plugin_sevens-core_sevens__agentdb_pattern-store` for reusable patterns discovered
