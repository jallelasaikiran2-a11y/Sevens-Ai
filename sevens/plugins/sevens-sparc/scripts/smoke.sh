...
[[ -f "$ROOT/commands/sevens-sparc.md" ]] || miss="$miss missing-command"
[[ -z "$miss" ]] && ok || bad "$miss"
...
F="$ROOT/commands/sevens-sparc.md"
...
F="$ROOT/README.md"
miss=""
for plugin in sevens-adr sevens-ddd sevens-jujutsu sevens-docs sevens-goals; do
