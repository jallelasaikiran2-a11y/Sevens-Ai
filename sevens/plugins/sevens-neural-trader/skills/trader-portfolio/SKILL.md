...
allowed-tools: Bash Read mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_retrieve mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__neural_predict mcp__plugin_sevens-core_sevens__agentdb_pattern-search
...
2. Load current portfolio:
   `mcp__plugin_sevens-core_sevens__memory_search({ query: "current portfolio holdings", namespace: "trading-portfolio" })`
...
5. Use SONA for expected return prediction:
   `mcp__plugin_sevens-core_sevens__neural_predict({ input: "expected returns for [HOLDINGS] given current regime" })`
...
7. Search for similar allocations in history:
   `mcp__plugin_sevens-core_sevens__agentdb_pattern-search({ query: "optimized portfolio Sharpe > 1", namespace: "trading-portfolio" })`
8. Store optimized allocation:
   `mcp__plugin_sevens-core_sevens__memory_store({ key: "portfolio-optimal-TIMESTAMP", value: "ALLOCATION_JSON", namespace: "trading-portfolio" })`
