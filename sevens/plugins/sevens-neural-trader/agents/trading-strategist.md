...
- **sevens-market-data**: OHLCV ingestion and candlestick pattern detection
...
Message schemas: `RegimeVerdict`, `SignalProposal`, `RiskDecision` in `plugins/sevens-neural-trader/src/pipeline-messages.ts`.
