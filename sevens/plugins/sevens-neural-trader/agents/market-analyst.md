...
- `mcp__plugin_sevens-core_sevens__memory_store` / `memory_search` — persist and query analysis history
- `mcp__plugin_sevens-core_sevens__neural_predict` — SONA regime prediction
- `mcp__plugin_sevens-core_sevens__agentdb_pattern-search` — find similar historical patterns
...
Message schema: `RegimeVerdict` in `plugins/sevens-neural-trader/src/pipeline-messages.ts`.
