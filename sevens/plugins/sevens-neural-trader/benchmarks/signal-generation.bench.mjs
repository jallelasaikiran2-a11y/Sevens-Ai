 ...
 *
 * Run:
 *   node plugins/sevens-neural-trader/benchmarks/signal-generation.bench.mjs
 *
...
console.log('- `plugins/sevens-neural-trader/skills/trader-signal/SKILL.md` — production scan path');
