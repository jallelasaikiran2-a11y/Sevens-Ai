 ...
 *
 * Run:
 *   node plugins/sevens-neural-trader/benchmarks/backtest-throughput.bench.mjs
 *
...
console.log('- `plugins/sevens-neural-trader/skills/trader-backtest/SKILL.md` — production backtest path');
