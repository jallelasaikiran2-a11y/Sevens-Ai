 ...
 *
 * Measures `mcp__plugin_sevens-core_sevens__memory_search`-style latency over the
 ...
 *
 * Run:
 *   node plugins/sevens-neural-trader/benchmarks/memory-recall.bench.mjs
 *
...
console.log('- `plugins/sevens-neural-trader/skills/trader-backtest/SKILL.md` — production recall path');
