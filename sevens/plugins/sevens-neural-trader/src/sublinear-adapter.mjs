...
//   The plugin (sevens-neural-trader) does not have a `package.json` /
...
export class SublinearAdapter {
   ...
   *   1) globalThis['mcp__sevens-sublinear__solve'] is a function
   *   2) process.env.SEVENS_SUBLINEAR_NATIVE === '1' (manual override)
  ...
  static detectSublinearTool() {
    try {
      const tool = globalThis['mcp__sevens-sublinear__solve'];
