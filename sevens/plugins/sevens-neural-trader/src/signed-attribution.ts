 ...
 * `mcp__sevens-sublinear__page-rank-entry` is not registered in the runtime.
 *
...
/**
 * True iff `mcp__sevens-sublinear__page-rank-entry` is registered in the
...
/**
 * Dispatch to `mcp__sevens-sublinear__page-rank-entry` when available, fall
