...
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__hooks_worker-dispatch Read Write Grep
---
...
Dispatch via MCP: `mcp__plugin_sevens-core_sevens__hooks_worker-dispatch({ trigger: "document", scope: "api" })`
