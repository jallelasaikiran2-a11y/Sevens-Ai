...
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__hooks_worker-dispatch mcp__plugin_sevens-core_sevens__memory_store CronCreate Read Write
---
Generate docs via MCP worker dispatch:
`mcp__plugin_sevens-core_sevens__hooks_worker-dispatch({ trigger: "document" })`
...
Store the approach: `mcp__plugin_sevens-core_sevens__memory_store({ key: "doc-pattern", value: "APPROACH", namespace: "patterns" })`
