...
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__swarm_init mcp__plugin_sevens-core_sevens__swarm_status Task SendMessage
---
Initialize a hierarchical swarm for coordinated multi-agent work.

Via MCP: `mcp__plugin_sevens-core_sevens__swarm_init({ topology: "hierarchical", maxAgents: 8, strategy: "specialized" })`
