...
argument-hint: ""
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__swarm_status mcp__plugin_sevens-core_sevens__swarm_health Monitor
---
...
For one-shot status, use MCP: `mcp__plugin_sevens-core_sevens__swarm_status` or `mcp__plugin_sevens-core_sevens__swarm_health`.
