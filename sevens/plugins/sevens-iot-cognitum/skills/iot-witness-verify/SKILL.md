...
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__memory_store Read
...
4. If gaps found, store for audit trail:
   `mcp__plugin_sevens-core_sevens__memory_store({ key: "iot-witness-gap-DEVICEID", value: "Gap from EPOCH to EPOCH", namespace: "iot-audit" })`
