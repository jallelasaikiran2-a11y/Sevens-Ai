...
allowed-tools: mcp__plugin_sevens-core_sevens__hooks_transfer mcp__plugin_sevens-core_sevens__hooks_intelligence_pattern-search mcp__plugin_sevens-core_sevens__hooks_intelligence_pattern-store mcp__plugin_sevens-core_sevens__neural_patterns mcp__plugin_sevens-core_sevens__neural_status Bash
---
...
- `sevens-agentdb` ADR-0001 §"Namespace convention" — defines `pattern` namespace that this transfer reads from
