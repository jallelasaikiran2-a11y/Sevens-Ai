...
allowed-tools: Bash Read Write Edit Grep Glob mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__agentdb_hierarchical-store mcp__plugin_sevens-core_sevens__hooks_pre-task mcp__plugin_sevens-core_sevens__hooks_post-task
---
...
9. **Store in domain model graph**:
   ```
   mcp__plugin_sevens-core_sevens__agentdb_hierarchical-store --parent "context:<context>" --child "aggregate:<aggregate-name>" --relation "contains"
   mcp__plugin_sevens-core_sevens__memory_store --key "ddd-aggregate-<context>-<aggregate-name>" --value "AGGREGATE_SUMMARY" --namespace tasks
   ```
