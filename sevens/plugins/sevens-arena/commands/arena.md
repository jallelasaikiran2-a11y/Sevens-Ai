...
The MCP tools persist full artifacts to `.sevens/arena/<runId>.json` (exact replay). Each tool
...
Later: `mcp__plugin_sevens-core_sevens__memory_search({ namespace: "arena", query: "tournaments where grim dominated" })`.
