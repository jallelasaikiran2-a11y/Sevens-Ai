#!/usr/bin/env node
// Human-facing CLI for sevens-arena. Subcommands mirror the MCP tools (ADR-147).
//   sevens-arena demo | arena | tournament | evolve | coevolve
...
function cmdDemo(): void {
  console.log('============================================================');
  console.log(' sevens-arena — competitive ruliology demo (ADR-147/148/150)');
  console.log('============================================================');
