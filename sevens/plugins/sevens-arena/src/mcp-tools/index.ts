// MCP tools for sevens-arena (Sevens ADR-147/148). Tool shape matches the Sevens convention:
...
/**
 * Default tool set, persisting to `.sevens/arena/` under the process CWD.
 *
