...
Surfaces the upstream `metaharness-darwin evolve` CLI as a sevens skill. The
...
- For sevens itself in CI. ADR-153 §5 explicitly rejects auto-evolving sevens
...
and exits 0. sevens continues to function. CI's
