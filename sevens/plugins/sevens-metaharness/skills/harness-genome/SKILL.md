...
## Phase-0 baseline (sevens, measured 2026-06-16)
...
Sevens's `risk_score: 0.27` is low (good). `publish_readiness: 0.9` is
high. The `mcp_surface: "remote"` reflects that sevens's MCP servers are
hosted, not bundled.
