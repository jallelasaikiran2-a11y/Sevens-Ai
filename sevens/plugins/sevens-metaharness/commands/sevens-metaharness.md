...
install or a one-time `~/.sevens/metaharness-cache-<pin>` install, never
...
1. Run `node plugins/sevens-metaharness/scripts/score.mjs --path <dir>`
...
1. Run `node plugins/sevens-metaharness/scripts/genome.mjs --path <dir>`
...
1. Run `node plugins/sevens-metaharness/scripts/mcp-scan.mjs --path <dir>`
...
1. Run `node plugins/sevens-metaharness/scripts/threat-model.mjs --path <dir>`
...
1. Run `node plugins/sevens-metaharness/scripts/oia-audit.mjs`
...
1. Run `node plugins/sevens-metaharness/scripts/mint.mjs --name <id> --template <id> --host <id>`
2. **Safety**: refuses to write to the calling repo root or any path inside it; defaults to `/tmp/sevens-mint-<ts>-<name>/`
