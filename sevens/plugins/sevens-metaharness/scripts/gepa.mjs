...
// 2. Fall back to a sevens-owned versioned cache install
//    (~/.sevens/darwin-cache-<pin>) — the versioned dir means pin bumps
...
function emitDegradedAndExit(reason) {
  ...
  process.exit(0);  // ADR-150 — sevens stays operational without MetaHarness
}
