...
//
// All sevens-metaharness skills shell out to the upstream CLI rather than
...
//      optionalDependencies in @claude-flow/cli + sevens package.json.
...
//      `npm install --prefix ~/.sevens/metaharness-cache-<pin>` versioned
...
// @claude-flow/cli/package.json + sevens/package.json. NEVER @latest.
...
// Exit 0 — ADR-150 architectural constraint says sevens continues to
