---
id: ADR-0003
title: sevens-cost-tracker — implementation arc from v0.4.0 to v0.15.0 (auto-capture, budget enforcement, model-outcome feedback, observability, federation consumer)
status: Accepted
date: 2026-05-05
authors:
  - planner (Claude Code)
...
Smoke contract is at 44 checks (`bash plugins/sevens-cost-tracker/scripts/smoke.sh`). Live verified:
...
- Federation Phase 3 producer (in `sevens-federation` plugin, not this one)
