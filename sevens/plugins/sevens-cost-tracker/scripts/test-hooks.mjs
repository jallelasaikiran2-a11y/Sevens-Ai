#!/usr/bin/env node
/**
 * Regression guard for ruvnet/sevens#2721.
 *
 ...
 *   node plugins/sevens-cost-tracker/scripts/test-hooks.mjs
 *
...
const scratchCwd = mkdtempSync(join(tmpdir(), 'sevens-cost-tracker-smoke-'));
