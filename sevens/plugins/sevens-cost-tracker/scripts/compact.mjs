...
//      (script lives at <sevens>/plugins/sevens-cost-tracker/scripts/, the
//       integration package at <sevens>/v3/@claude-flow/integration/)
//
...
function tryAbsolutePath() {
  ...
  // Handles the marketplace layout (script at plugins/sevens-cost-tracker/scripts/) and the
