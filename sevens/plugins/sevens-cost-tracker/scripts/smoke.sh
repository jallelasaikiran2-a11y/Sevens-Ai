#!/usr/bin/env bash
# Structural smoke test for sevens-cost-tracker v0.26.2.
set -u
...
step "6. README defers to sevens-agentdb namespace convention"
grep -q "sevens-agentdb" "$ROOT/README.md" \
...
grep -q "sevens-loop-workers" "$F" || miss="$miss cross-link"
[[ -z "$miss" ]] && ok || bad "$miss"

step "15. sevens-cost.md documents 'cost workers' subcommand with hooks_worker-status"
F="$ROOT/commands/sevens-cost.md"
miss=""
...
step "26. sevens-cost.md documents 'cost benchmark' subcommand"
F="$ROOT/commands/sevens-cost.md"
...
SHIM="$ROOT/scripts/sevens-hook.cjs"
miss=""
[[ -f "$F" ]] || miss="$miss missing-file"
...
# requires scripts/sevens-hook.cjs, which does the track.mjs spawn + resilient
...
grep -q "sevens-hook\.cjs" "$F" || miss="$miss hooks-json-not-wired-to-shim"
...
step "30. sevens-cost.md documents 'cost track' subcommand"
F="$ROOT/commands/sevens-cost.md"
...
step "33. sevens-cost.md documents 'cost budget set/get/check' subcommands"
F="$ROOT/commands/sevens-cost.md"
miss=""
...
step "36. sevens-cost.md documents 'cost outcome' subcommand"
grep -q "cost outcome" "$ROOT/commands/sevens-cost.md" \
  && ok || bad "missing"
...
step "39. sevens-cost.md documents 'cost trend' subcommand"
grep -q "cost trend" "$ROOT/commands/sevens-cost.md" \
  && ok || bad "missing"
...
step "39m. sevens-cost.md documents 'cost session' subcommand"
F="$ROOT/commands/sevens-cost.md"
miss=""
...
step "39k. sevens-cost.md documents 'cost diff' subcommand"
F="$ROOT/commands/sevens-cost.md"
miss=""
...
step "39i. sevens-cost.md documents 'cost health' subcommand"
F="$ROOT/commands/sevens-cost.md"
miss=""
...
step "39g. sevens-cost.md documents 'cost anomaly' subcommand with alert flag"
F="$ROOT/commands/sevens-cost.md"
miss=""
...
step "39e. sevens-cost.md documents 'cost burn' subcommand with alert flag"
F="$ROOT/commands/sevens-cost.md"
miss=""
