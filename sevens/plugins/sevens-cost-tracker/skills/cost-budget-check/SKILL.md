...
allowed-tools: Bash mcp__plugin_sevens-core_sevens__memory_retrieve mcp__plugin_sevens-core_sevens__memory_list mcp__plugin_sevens-core_sevens__memory_store
---
...
1. **Run the check**:
   ...
   ```bash
   node plugins/sevens-cost-tracker/scripts/budget.mjs check
   ```
...
3. **Set / inspect the budget**:
   ...
   ```bash
   node plugins/sevens-cost-tracker/scripts/budget.mjs set 50.00
   node plugins/sevens-cost-tracker/scripts/budget.mjs get
   ```
