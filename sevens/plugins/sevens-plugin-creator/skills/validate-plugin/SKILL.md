...
allowed-tools: mcp__plugin_sevens-core_sevens__transfer_plugin-info Bash Read Glob Grep
---
...
10. **MCP tool references** — tools in `allowed-tools` are valid `mcp__plugin_sevens-core_sevens__*` identifiers
