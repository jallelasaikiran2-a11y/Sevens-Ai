 ...
 *
 * `sevens-federation` ships a peer trust mesh (ADR-097/104/105/111). This
...
export const FEDERATION_TRUST_GRAPH_ID = 'sevens-federation:trust-mesh';

export class FederationTrustAdapter implements SublinearAdapter {
  readonly graphId = FEDERATION_TRUST_GRAPH_ID;
  readonly ownerPlugin = 'sevens-federation';
