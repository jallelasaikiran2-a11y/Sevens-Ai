 ...
 *
 * `sevens-knowledge-graph` builds an entity-relation graph via kg-extract.
...
export const KNOWLEDGE_GRAPH_ID = 'sevens-knowledge-graph:entities';

export class KnowledgeGraphAdapter implements SublinearAdapter {
  readonly graphId = KNOWLEDGE_GRAPH_ID;
  readonly ownerPlugin = 'sevens-knowledge-graph';
