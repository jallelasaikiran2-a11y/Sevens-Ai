 ...
 *
 * `sevens-neural-trader` does mean-variance optimisation: solve `Σ x = μ`
...
export function portfolioGraphId(portfolioId: string): string {
  return `sevens-neural-trader:covariance:${portfolioId}`;
}

export class PortfolioCovarianceAdapter implements SublinearAdapter {
  readonly graphId: string;
  readonly ownerPlugin = 'sevens-neural-trader';
