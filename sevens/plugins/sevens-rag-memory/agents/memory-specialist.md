...
- **sevens-agentdb**: Full AgentDB backend with HNSW vector_indexes table
- **sevens-ruvector**: FlashAttention-3, Graph RAG, hybrid search, DiskANN
- **sevens-rvf**: Portable RVF format for cross-machine memory export/import
- **sevens-knowledge-graph**: Entity-relationship graphs over memory entries
- **sevens-intelligence**: SONA trajectory learning from retrieval patterns
