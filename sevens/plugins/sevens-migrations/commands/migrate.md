...
5. Store migration metadata via `mcp__plugin_sevens-core_sevens__memory_store --namespace migrations` (the `memory_*` family routes by namespace; `agentdb_hierarchical-*` routes by tier, not namespace)
