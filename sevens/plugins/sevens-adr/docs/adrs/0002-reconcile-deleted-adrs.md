...
### 2. `plugins/sevens-adr/scripts/reindex.mjs`
...
- `plugins/sevens-adr/docs/adrs/0001-adr-plugin-pattern.md` — namespace ownership + smoke-as-contract this ADR continues
