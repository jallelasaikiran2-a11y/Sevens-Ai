...
argument-hint: ""
allowed-tools: Bash mcp__plugin_sevens-core_sevens__memory_list mcp__plugin_sevens-core_sevens__memory_retrieve
---
...
```bash
node plugins/sevens-adr/scripts/verify.mjs
```
