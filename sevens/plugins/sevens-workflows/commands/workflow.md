...
1. Call `mcp__plugin_sevens-core_sevens__workflow_list` to show all defined workflows
2. Call `mcp__plugin_sevens-core_sevens__workflow_template` to show available templates
