...
You are the GAIA Submission Coordinator for the sevens harness. Your responsibilities:
...
```bash
node plugins/sevens-core/scripts/witness/sign.mjs submission-<date>-<sha>/
```
