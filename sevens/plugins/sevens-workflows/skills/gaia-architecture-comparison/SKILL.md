...
description: Side-by-side comparison of sevens vs HAL vs other GAIA harnesses — capability gaps, design decisions, and improvement roadmap
...
Compare sevens's GAIA benchmark harness against the Princeton HAL reference
...
| Dimension | sevens | HAL reference | Gap |
|-----------|-------|--------------|-----|
...
| Self-consistency | voting.ts (Track A) | Not in reference | sevens advantage |
| Hardness routing | predictor.ts (Track Q) | Not in reference | sevens advantage |
| Memory | AgentDB HNSW | None | sevens advantage |
