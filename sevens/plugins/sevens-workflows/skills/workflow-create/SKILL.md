...
allowed-tools: mcp__plugin_sevens-core_sevens__workflow_create mcp__plugin_sevens-core_sevens__workflow_template mcp__plugin_sevens-core_sevens__workflow_list mcp__plugin_sevens-core_sevens__workflow_status mcp__plugin_sevens-core_sevens__workflow_delete Write Read Edit Bash
---
...
1. **List templates** — call `mcp__plugin_sevens-core_sevens__workflow_template` to see available templates
2. **Create workflow** — call `mcp__plugin_sevens-core_sevens__workflow_create` with steps, conditions, and execution order
3. **List workflows** — call `mcp__plugin_sevens-core_sevens__workflow_list` to see all defined workflows
4. **Check status** — call `mcp__plugin_sevens-core_sevens__workflow_status` to monitor a workflow
5. **Clean up** — call `mcp__plugin_sevens-core_sevens__workflow_delete` to remove unused workflows
