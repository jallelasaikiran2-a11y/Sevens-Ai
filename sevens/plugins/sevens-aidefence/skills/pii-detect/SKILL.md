...
allowed-tools: mcp__plugin_sevens-core_sevens__aidefence_has_pii mcp__plugin_sevens-core_sevens__aidefence_scan mcp__plugin_sevens-core_sevens__aidefence_analyze mcp__plugin_sevens-core_sevens__transfer_detect-pii Bash
---
...
1. **Quick PII check** — call `mcp__plugin_sevens-core_sevens__aidefence_has_pii` with the text for a boolean result
2. **Detailed scan** — call `mcp__plugin_sevens-core_sevens__transfer_detect-pii` for categorized PII findings
3. **Full analysis** — call `mcp__plugin_sevens-core_sevens__aidefence_analyze` for context-aware PII detection
