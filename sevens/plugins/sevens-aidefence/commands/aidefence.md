...
allowed-tools: mcp__plugin_sevens-core_sevens__aidefence_stats
---

Show the AIDefence dashboard:

1. Call `mcp__plugin_sevens-core_sevens__aidefence_stats` to get detection rates, scan counts, and learned patterns
