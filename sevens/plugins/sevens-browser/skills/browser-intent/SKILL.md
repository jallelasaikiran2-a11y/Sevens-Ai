...
allowed-tools: mcp__plugin_sevens-core_sevens__browser_act mcp__plugin_sevens-core_sevens__browser_open mcp__plugin_sevens-core_sevens__browser_snapshot mcp__plugin_sevens-core_sevens__browser_close mcp__plugin_sevens-core_sevens__aidefence_has_pii mcp__plugin_sevens-core_sevens__aidefence_is_safe Bash Read
---
...
1. **Call `browser_act`** with a `task` string, and optionally `url` (navigates first) and `session` (default `"default"`):
   ```
   mcp__plugin_sevens-core_sevens__browser_act({
