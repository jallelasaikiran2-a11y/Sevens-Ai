...
allowed-tools: mcp__plugin_sevens-core_sevens__browser_open mcp__plugin_sevens-core_sevens__browser_close mcp__plugin_sevens-core_sevens__browser_get-text mcp__plugin_sevens-core_sevens__browser_get-value mcp__plugin_sevens-core_sevens__browser_eval mcp__plugin_sevens-core_sevens__browser_snapshot mcp__plugin_sevens-core_sevens__browser_screenshot mcp__plugin_sevens-core_sevens__browser_scroll mcp__plugin_sevens-core_sevens__browser_wait mcp__plugin_sevens-core_sevens__browser_click mcp__plugin_sevens-core_sevens__aidefence_has_pii mcp__plugin_sevens-core_sevens__aidefence_is_safe mcp__plugin_sevens-core_sevens__aidefence_scan Bash Read Write
---
...
4. **AIDefence pre-storage**: every extracted string passes the PII gate.
   ```bash
   # Pseudocode — mcp__plugin_sevens-core_sevens__aidefence_has_pii returns true/false per string.
