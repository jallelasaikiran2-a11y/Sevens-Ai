...
allowed-tools: mcp__plugin_sevens-core_sevens__browser_open mcp__plugin_sevens-core_sevens__browser_close mcp__plugin_sevens-core_sevens__browser_click mcp__plugin_sevens-core_sevens__browser_fill mcp__plugin_sevens-core_sevens__browser_type mcp__plugin_sevens-core_sevens__browser_press mcp__plugin_sevens-core_sevens__browser_select mcp__plugin_sevens-core_sevens__browser_check mcp__plugin_sevens-core_sevens__browser_uncheck mcp__plugin_sevens-core_sevens__browser_hover mcp__plugin_sevens-core_sevens__browser_wait mcp__plugin_sevens-core_sevens__browser_screenshot mcp__plugin_sevens-core_sevens__browser_snapshot mcp__plugin_sevens-core_sevens__browser_eval Bash Read
---
...
- Forking a session (`/sevens-browser fork`) and replaying the parent before mutating.
...
3. **Open a fresh browser** via `mcp__plugin_sevens-core_sevens__browser_open` (target URL = original or `--url` override).
