...
allowed-tools: mcp__plugin_sevens-core_sevens__browser_open mcp__plugin_sevens-core_sevens__browser_click mcp__plugin_sevens-core_sevens__browser_fill mcp__plugin_sevens-core_sevens__browser_type mcp__plugin_sevens-core_sevens__browser_press mcp__plugin_sevens-core_sevens__browser_check mcp__plugin_sevens-core_sevens__browser_uncheck mcp__plugin_sevens-core_sevens__browser_select mcp__plugin_sevens-core_sevens__browser_hover mcp__plugin_sevens-core_sevens__browser_wait mcp__plugin_sevens-core_sevens__browser_screenshot mcp__plugin_sevens-core_sevens__browser_snapshot mcp__plugin_sevens-core_sevens__browser_get-text mcp__plugin_sevens-core_sevens__browser_get-title mcp__plugin_sevens-core_sevens__browser_get-url mcp__plugin_sevens-core_sevens__browser_get-value mcp__plugin_sevens-core_sevens__browser_eval mcp__plugin_sevens-core_sevens__browser_close mcp__plugin_sevens-core_sevens__browser_session-list mcp__plugin_sevens-core_sevens__aidefence_is_safe Bash Read Write
---
...
- The same skill, used in CI, now produces an artifact that `/sevens-browser replay` can re-drive.
