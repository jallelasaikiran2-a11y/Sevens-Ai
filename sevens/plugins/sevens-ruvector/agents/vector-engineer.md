...
- **sevens-agentdb**: HNSW storage backend — persists indexes in AgentDB
- **sevens-intelligence**: Neural embeddings and SONA pattern learning
- **sevens-rag-memory**: Simple semantic search delegating to ruvector
- **sevens-knowledge-graph**: Graph RAG integration for multi-hop retrieval
