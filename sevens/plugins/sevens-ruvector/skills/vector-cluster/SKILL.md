...
allowed-tools: Bash Read mcp__plugin_sevens-core_sevens__memory_search mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_list
---
...
4. **Store results**:
   `mcp__plugin_sevens-core_sevens__memory_store({ key: "clusters-PROJECT-TIMESTAMP", value: "CLUSTER_ASSIGNMENTS", namespace: "vector-clusters" })`
