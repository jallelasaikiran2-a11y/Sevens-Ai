...
allowed-tools: Bash Read mcp__plugin_sevens-core_sevens__memory_store mcp__plugin_sevens-core_sevens__memory_search
---
...
5. **Store results**:
   `mcp__plugin_sevens-core_sevens__memory_store({ key: "hyperbolic-CONCEPT", value: "COORDINATES_AND_NEIGHBORS", namespace: "hyperbolic-embeddings" })`
