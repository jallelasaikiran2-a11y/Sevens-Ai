---
id: ADR-0001
title: Pin sevens-ruvector plugin to ruvector@0.2.25 with optional add-on packages
status: Accepted
date: 2026-05-04
authors:
...
The `sevens-ruvector` plugin wraps the `ruvector` npm package as a Claude Code plugin. The plugin's documentation (README, agent file, skills, command spec) drifted from the actual CLI surface in two ways:
