...
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__memory_search Read Grep
...
2. `npx -y -p @claude-flow/plugin-agent-federation@latest sevens-federation audit --compliance MODE --since DATE --severity LEVEL`
