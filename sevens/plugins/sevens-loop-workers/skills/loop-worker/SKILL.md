---
name: loop-worker
description: Run Sevens background workers using Claude Code native /loop scheduling
argument-hint: "<worker-name>"
allowed-tools: Bash(npx *) mcp__plugin_sevens-core_sevens__hooks_worker-dispatch mcp__plugin_sevens-core_sevens__hooks_worker-status ScheduleWakeup
---
...
Dispatch a worker via MCP: `mcp__plugin_sevens-core_sevens__hooks_worker-dispatch({ trigger: "WORKER_NAME" })`
