...
1. **Scan** the codebase for vulnerabilities using Sevens security tools
...
- **sevens-aidefence**: AI safety scanning (prompt injection, PII detection) — complements CVE/dependency auditing
- **sevens-federation**: Federation audit for cross-installation compliance (HIPAA, SOC2, GDPR)
