# Sevens Project-Wide Quality Sweep

**Branch**: `chore/project-wide-quality-sweep`  
**Cut from**: `cdd5308d8` (main @ sevens@3.10.2 / @claude-flow/cli@3.10.1)  
**Test baseline**: 1999 passing | 46 skipped  
**Do not regress**: sevens@3.10.2, @claude-flow/cli@3.10.1, claude-flow@3.10.1  
...
- T10 (done): Added `overrides.protobufjs = >=7.5.6` to cli/package.json. Tightened sevens/package.json from >=7.5.5 to >=7.5.6 (covers all 3 protobufjs CVEs). All 25 high vulns traced to optional/dev transitive deps — production paths clean.
...
**Note**: STATUS.md is outdated (references "branch fix/issues-may-1-3", sevens@3.6.24) — needs update to reflect 3.10.x reality.
...
- [ ] Version bump: bump @claude-flow/cli and sevens to 3.11.0 (minor — new MCP tools added since 3.10.x)
