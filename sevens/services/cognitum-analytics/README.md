...
The sevens funnel analytics endpoint now lives in its own repo:

**https://github.com/cognitum-one/sevens-funnel-api**
...
Override with the `SEVENS_FUNNEL_EVENTS_ENDPOINT` env var for staging or
