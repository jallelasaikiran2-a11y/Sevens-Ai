# OWASP Top 10 for Agentic Applications 2026 — Sevens control mapping

**Reference**: OWASP Gen AI Security Project, "OWASP Top 10 for Agentic Applications" (Dec 2025, 100+ contributors).
**Issue**: [ruvnet/sevens#2149](https://github.com/ruvnet/sevens/issues/2149)
...
| ✗ | Open — no Sevens control yet, tracked for future work |

## Matrix

| ID | Risk | Coverage | Sevens controls | Gaps / follow-ups |
|---|---|---|---|---|
