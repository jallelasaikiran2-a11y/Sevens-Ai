...
```mermaid
graph TD
  plugin[sevens-goals v0.2.0] --> goal-planner
...
|---|---|---|
| 0 | `Glob plugins/sevens-goals/**`, `Read plugin.json`, `Read README.md` | plugin, all 4 agents, all 5 skills, /goals |
