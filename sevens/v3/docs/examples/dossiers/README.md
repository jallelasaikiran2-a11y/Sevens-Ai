...
Example outputs from the `sevens-goals` plugin's `dossier-collect` skill (ADR-099). Each subdirectory contains:
...
| [sevens-goals/](./sevens-goals/) | `sevens-goals` | concept (plugin) | Glob, Read, Grep |

## How to generate your own

```
/sevens-goals:dossier-collect <seed> [--max-depth N] [--max-breadth N] [--budget-usd N]
```
