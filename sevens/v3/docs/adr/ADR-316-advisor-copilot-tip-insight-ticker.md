...
FableHarness.adviseCoPilotTip(structuralSnapshot)   [services/fable-harness.ts]
        │  writes
        ▼
~/.sevens/advisor-tip.json  { _ts, headline, detail }
