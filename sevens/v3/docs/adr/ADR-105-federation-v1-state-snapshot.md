...
| Cost-tracker consumer (sevens-cost-tracker) | ADR-097 P3 consumer | `plugins/sevens-cost-tracker/scripts/federation.mjs` | Integration |
...
| `sevens doctor --component federation` health-check | ADR-097 P4 | `v3/@claude-flow/cli/src/commands/doctor.ts` | Smoke |
...
| `sevens` | `alpha`/`latest`/`v3alpha` | `3.7.0-alpha.20` |
...
# Health-check
npx sevens@latest doctor --component federation
