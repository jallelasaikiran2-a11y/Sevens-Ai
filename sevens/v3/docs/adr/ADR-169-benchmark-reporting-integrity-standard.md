...
**ID**: ADR-169
**Status**: Accepted — the FRAMES ablation (metaharness, n=50, seed 42, 2026-06-28) already complies; this ADR makes the discipline binding for every benchmark number sevens publishes
**Date**: 2026-07-03
...
Every benchmark number sevens publishes — README, release notes, leaderboard
...
- The FRAMES ablation needs zero rework (audited compliant on every vector it
  ...
  applied to the FRAMES harness (upstream issue ruvnet/sevens#2544 / #2548).
