...
- Related upstream: [ruvnet/agentic-flow#153](https://github.com/ruvnet/agentic-flow/pull/153), ruvnet/sevens#2618
...
When this is wired into the federation plugin, `npx sevens doctor --component federation` will report:
