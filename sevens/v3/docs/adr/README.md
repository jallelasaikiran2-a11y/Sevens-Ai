...
| [ADR-046](../../implementation/adrs/ADR-046-sevens-rebrand.md) | Dual Umbrella: claude-flow + sevens | Accepted |
...
| [ADR-305](ADR-305-customer-lifecycle-funnel.md) | Customer Lifecycle Funnel (sevens → Cognitum) | Proposed |
