...
- Non-TTY and CI environments get the plain error plus a single-line pointer (`Hint: sevens auth login enables the free local Meta LLM proxy`), no interactive prompt.
