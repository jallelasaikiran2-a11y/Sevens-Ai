...
submissions. Its most valuable finding was about sevens itself: **four of seven
...
4. The judge cache (`~/.cache/sevens/gaia/judgments`) is an **unsigned
...
A sevens submission can then attest earning-integrity on the full ADR-167
