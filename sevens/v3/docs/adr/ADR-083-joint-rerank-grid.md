...
**Status**: Accepted — Implemented in sevens 3.10.23
**Date**: 2026-05-30
...
- **Cross-repo generalisation pending** — all numbers in ADRs 077-083 are on the sevens corpus. The real SOTA test is "does this hold up on a different repo's history?" — pretrain on agentdb / agentic-flow, run a similar labelled bench, see if nDCG@3 stays near 0.96. Tracked for the next iteration.
