...
<p align="center">
  ...
  <a href="https://github.com/ruvnet/sevens"><img src="https://img.shields.io/badge/license-MIT-green" alt="license"></a>
...
npx sevens@latest init --codex --minimal
...
# Use command mode for recurring Sevens workers or custom scripts
...
# Rebuild skills
npx sevens@latest init --codex --force
```
...
- Documentation: https://github.com/ruvnet/sevens
