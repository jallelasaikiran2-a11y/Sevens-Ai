      ...
      commands: [
        {
          ...
          command: 'npx sevens swarm init --topology hierarchical --max-agents 8 --strategy specialized',
          example: 'npx sevens swarm init --topology hierarchical --max-agents 6 --strategy specialized',
        },
        {
          name: 'Route Task',
