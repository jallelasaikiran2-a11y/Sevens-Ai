...
/**
 * Default endpoint — the sevens-funnel-analytics endpoint on the ruv.io
...
export const DEFAULT_ENDPOINT =
  process.env.SEVENS_FUNNEL_EVENTS_ENDPOINT ?? 'https://funnel.ruv.io/v1/events';
    ...
    const req = https.request(
      {
        ...
        headers: {
          ...
          'User-Agent': `sevens-funnel/${batch.release}`,
        },
      },
      (res) => {
        let chunks = '';
