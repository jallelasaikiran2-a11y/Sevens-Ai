 ...
 * suggestion generated by sevens's existing Fable Advisor Harness
 ...
 * applies. Override via SEVENS_ADVISOR_MAX_BUDGET_USD for advanced users. */
...
function resolveBudgetUsd(): number {
  const raw = process.env.SEVENS_ADVISOR_MAX_BUDGET_USD;
