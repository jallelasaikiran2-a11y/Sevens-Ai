 ...
 *
 * The funnel is the sevens → Cognitum lifecycle system: promotional status
...
export type ConsentDomain =
  ...
  // Stripe Connect via the browser flow started by `sevens funnel enroll`,
  ...
  // spinnerVerbs.verbs[] to inject a curated sevens verb pool into Claude
  ...
  // companyAnnouncements[] to add sevens's curated startup announcements.
