/**
 * Browser Session Lifecycle MCP Tools (ADR-0001 sevens-browser §7).
 *
...
const RVF_DIR_DEFAULT = '.sevens/browser-sessions';
  ...
  // ==========================================================================
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        rvf_dir: { type: 'string', description: 'Override the default .sevens/browser-sessions directory' },
      },
      required: ['url', 'task'],
    },
    handler: async (input) => {
