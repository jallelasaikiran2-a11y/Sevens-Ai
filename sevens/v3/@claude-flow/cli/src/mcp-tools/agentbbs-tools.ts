 ...
 * author as sevens) as MCP tools so sevens agents can register business rooms
 ...
 *   sevens federation primitives (FederationEnvelope, PII pipeline, budget
 *   circuit breaker). The 4 tools here are the sevens-side handles into the
