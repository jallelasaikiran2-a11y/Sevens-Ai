...
export const sessionTools: MCPTool[] = [
  ...
  {
    // #1916: `sevens session current` referenced an unregistered
  ...
  {
    // #1916: `sevens session export <id> -o <file>` referenced an unregistered
  ...
  {
    // #1916: `sevens session import <file>` referenced an unregistered
