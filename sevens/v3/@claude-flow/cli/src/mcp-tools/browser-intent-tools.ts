...
export const PLACEHOLDER_API_KEY = 'sevens-proxied-key';
...
export const BROWSER_ACT_RESULT_GLOBAL = '__sevens_browser_act_result__';
...
;(function(){
  ...
  try {
    ...
    window.__sevens_pageAgent__ = agent;
