...
const PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  // sevens Primary Providers (in priority order)
  { name: 'OpenRouter', type: 'LLM', models: 'deepseek/deepseek-chat, deepseek/deepseek-r1, qwen/qwen-2.5-coder-32b-instruct, google/gemini-2.0-flash-001', envVar: 'OPENROUTER_API_KEY', configName: 'openrouter' },
  { name: 'Gemini', type: 'LLM', models: 'gemini-2.0-flash-001, gemini-2.5-pro, gemini-2.0-flash-exp', envVar: 'GEMINI_API_KEY', configName: 'gemini' },
  // Optional Providers
  { name: 'Anthropic', type: 'LLM', models: 'claude-3.5-sonnet, claude-opus-4-8', envVar: 'ANTHROPIC_API_KEY', configName: 'anthropic' },
...
function resolveApiKey(
  ...
  // Check environment variable — OpenRouter and Gemini are primary for sevens
...
export const providersCommand: Command = {
  ...
  action: async (): Promise<CommandResult> => {
    output.writeln();
    output.writeln(output.bold('sevens Provider Management'));
