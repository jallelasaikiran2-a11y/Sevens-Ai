 ...
 * `SEVENS_EMBED_WASM_PKG` at any real WASM embedder that follows the ruvnet
 ...
 * `SEVENS_LATTICE_WASM_PKG` is accepted as a back-compat alias.
 */
export const EMBED_WASM_PKG = process.env.SEVENS_EMBED_WASM_PKG || process.env.SEVENS_LATTICE_WASM_PKG || '';
export const DEFAULT_EMBED_MODEL = process.env.SEVENS_EMBED_MODEL || 'default';
