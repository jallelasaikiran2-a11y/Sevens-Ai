...
// but were never registered, so the `sevens hooks coverage-*` CLI subcommands
...
/**
 * Lifecycle MCP tools for sevens-browser session-as-skill architecture
 * (ADR-0001 sevens-browser §7). Always registered: their handlers shell out
