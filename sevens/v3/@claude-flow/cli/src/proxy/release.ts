 ...
 *   gated behind `SEVENS_DEV_PROXY_INSTALL=1` so it is never reachable by
...
const DEV_INSTALL_ENV = 'SEVENS_DEV_PROXY_INSTALL';
const RELEASE_SOURCE_ENV = 'SEVENS_PROXY_RELEASE_SOURCE';
 ...
 * is NOT something a normal sevens end user has, which is exactly why this
