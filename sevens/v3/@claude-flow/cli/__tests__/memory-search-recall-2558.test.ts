...
const NS = 'recall2558';
const ENTRIES = [
  { key: 'note/alpha', value: 'sevens memory connectivity health probe alpha', unique: 'probe' },
  { key: 'note/beta', value: 'sevens memory connectivity latency check beta', unique: 'latency' },
  { key: 'note/gamma', value: 'sevens memory connectivity throughput report gamma', unique: 'throughput' },
];
