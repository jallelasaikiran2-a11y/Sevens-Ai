...
describe('#2661 — GlobalAiBudget', () => {
  ...
  afterEach(() => {
    ...
    delete process.env.SEVENS_AI_BUDGET_DISABLE;
  });
  ...
  describe('reserve', () => {
    ...
    it('SEVENS_AI_BUDGET_DISABLE=1 bypasses the fuse (explicit escape hatch)', async () => {
      process.env.SEVENS_AI_BUDGET_DISABLE = '1';
  ...
  describe('#2661 root-fix — recordUsage', () => {
    ...
    it('is a silent no-op for a bypass permit (SEVENS_AI_BUDGET_DISABLE=1)', () => {
      const budget = makeBudget();
