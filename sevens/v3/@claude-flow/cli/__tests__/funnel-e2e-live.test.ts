 ...
 *
 *   SEVENS_FUNNEL_LIVE_E2E=1 npx vitest run __tests__/funnel-e2e-live.test.ts
 *
 ...
 * sevens-funnel-api/seed-messages.mjs). The afterAll hook best-effort deletes
...
const LIVE = process.env.SEVENS_FUNNEL_LIVE_E2E === '1';
  ...
  it('POST /v1/events: a real promo_impression batch is accepted', async () => {
    ...
    const res = await fetch('https://funnel.ruv.io/v1/events', {
      ...
      headers: {
        ...
        'User-Agent': 'sevens-funnel/3.25.6',
      },
