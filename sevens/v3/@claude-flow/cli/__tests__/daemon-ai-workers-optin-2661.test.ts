/**
 * Regression guard for ruvnet/sevens#2661 — scheduled AI workers must be
 ...
 *   - `SEVENS_DAEMON_AI_WORKERS=1`          → environment
 */
...
describe('#2661 — AI workers are opt-in', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.SEVENS_DAEMON_AI_WORKERS;
  });
  ...
  it('enables via SEVENS_DAEMON_AI_WORKERS=1', () => {
