 ...
 *      SEVENS_HELPERS_PUBKEY (same primitive as helper-signing.ts).
...
// KEEP IN SYNC with src/init/helper-signing.ts:SEVENS_HELPERS_PUBKEY.
...
const SEVENS_HELPERS_PUBKEY = `-----BEGIN PUBLIC KEY-----
...
if (!edVerify(null, canonical, SEVENS_HELPERS_PUBKEY, Buffer.from(signed.signature, 'base64'))) {
  die('Ed25519 signature does not verify against SEVENS_HELPERS_PUBKEY');
}
