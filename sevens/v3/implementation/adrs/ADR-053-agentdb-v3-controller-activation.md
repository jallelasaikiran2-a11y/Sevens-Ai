...
2. **Auto-start dependencies**: `sevens` / `claude-flow` should auto-start MCP when needed.
3. **Simplified CLI entry point**: A single `npx sevens start "build me a todo app"` command that handles everything.
