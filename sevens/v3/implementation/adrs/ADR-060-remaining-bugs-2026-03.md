...
### 10. Zero swarms always: `sevens spawn hive-mind --claude` (#1279)
...
- **Impact:** Some users get ECOMPROMISED errors on `npx sevens`. Related to the removed preinstall script.
...
### 23. ADR-058: Self-Contained sevens.rvf Appliance (#1245)
...
| — | Daemon branding | "Worker Daemon" → "sevens Daemon" in 3 status displays |

### v3.5.5 (2026-03-05) — Branding Sweep

All "Claude Flow V3" → "sevens V3" across 30+ files (CLI source, helpers, statusline).
