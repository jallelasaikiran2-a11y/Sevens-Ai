...
function addTestSections(writer: RvfaWriter): void {
  ...
  writer.addSection('sevens', Buffer.from('sevens-payload'), { compression: 'none' });
}
...
describe('RvfaWriter', () => {
  ...
  it('section offsets are correct and non-overlapping', () => {
    ...
    writer.addSection('sevens', Buffer.from('ccccccc'), { compression: 'none' });
...
describe('RvfaReader', () => {
  ...
  it('handles multiple sections', () => {
    ...
    writer.addSection('sevens', Buffer.from('f'), { compression: 'none' });
