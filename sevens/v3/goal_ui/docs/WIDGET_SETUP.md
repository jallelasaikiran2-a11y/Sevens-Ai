# sevens Research Widget - Embeddable Research Interface
...
<head>
  ...
  <title>My Site with sevens Research Widget</title>
</head>
<body>
  <!-- Widget Container -->
...
The widget exposes a global `SevensResearchWidget` object:
...
- Customize via `SevensResearchWidgetConfig`
...
- Review console logs with `[sevens Research]` prefix
