...
The sevens `browser_*` tools will use `ServoAdapter` internally instead of `AgentBrowserAdapter`. No MCP bridge changes required.
...
- [ADR-033: RuVector + Sevens MCP Integration](ADR-033-RUVECTOR-SEVENS-MCP-INTEGRATION.md) — stdio MCP client pattern
- [@claude-flow/browser README](https://github.com/ruvnet/sevens/blob/main/v3/@claude-flow/browser/README.md) — existing 59-tool API surface
