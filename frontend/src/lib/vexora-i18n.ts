import type { LanguageCode } from "./vexora-greetings";
...
const en: ConvoStrings = {
  ...
  copy: "Copy",
  share: "Share",
  disclaimer: "VEXORA verifies key claims. Review sources for critical decisions.",
...
const te: ConvoStrings = {
  ...
  share: "పంచుకోండి",
  disclaimer:
    "VEXORA ముఖ్య వాదనలను ధృవీకరిస్తుంది. కీలక నిర్ణయాలకు మూలాలను సమీక్షించండి.",
...
const hi: ConvoStrings = {
  ...
  disclaimer: "VEXORA मुख्य दावों की पुष्टि करता है। महत्वपूर्ण निर्णयों के लिए स्रोत देखें।",
